...
ActiveRecord::Schema.define(version: 20140412195108) do
  ...
  add_index "observation_questions", ["instrument_id"], name: "index_observation_questions_on_instrument_id", using: :btree
